...
Dado que el PRD ya tiene 2 requerimientos registrados (RF001 y RF002)
Cuando se agrega un tercer requerimiento con 'add --requerimiento'
Entonces el script le asigna automáticamente el ID RF003, sin que el LLM tenga que llevar la cuenta
...
Entonces el script le asigna el ID RF001
